...
class wx_gzh(object):
    ...
    def __init__(self):
        ...
        self.offset = 0
        self.count = 0
        self.author_pic = 'https://mmbiz.qpic.cn/mmbiz_jpg/dib4iaLLsLibtzPibB3xpuMtZ6g0aU5T1ByeUSZJdC0hBjVVFnhyJbHQygCutg6SRpGW8Ol3WuKhFYwPz56pKaAPhw/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1'
        self.gzh_name = 'Spenser'
        self.base_url = 'https://mp.weixin.qq.com/mp/profile_ext?action=getmsg&__biz=MzA3NjU2MDUzMA==&f=json&offset={}&count=10&is_ok=1&scene=124&uin=NjY2Mzg5MDY0&key=a2ed73936a3136e4c1efd68b3ff8d919c946fbc410fddde6a783f76910af035b3c01fa544ce950848037c1e8edd0250a7365eee6163bfe635642fbe93e01c078902b801d8b08c3c02be52fc62cb42b4c&pass_ticket=5Zx%2F6KSKXNBH%2BaeYBg4b7bKsVQxXIMf%2BS8GiZKBneQiu9dtMJzUuN33ddCWWtnnf&wxtoken=&appmsg_token=1014_tB2Q49wrsbt8nKCCaQNBBtD4V3k1J76aHtVm5A~~&x5=0&f=json'
        self.cookie = 'rewardsn=; wxtokenkey=777; wxuin=666389064; devicetype=Windows10; version=62060833; lang=zh_CN; pass_ticket=5Zx/6KSKXNBH+aeYBg4b7bKsVQxXIMf+S8GiZKBneQiu9dtMJzUuN33ddCWWtnnf; wap_sid2=CMiU4b0CElxVbDNxT0d6Yk10RkowbWFOQWhWQUtDQ004STR2UXhVcEdQMWJHVEFaT1ZIMUwzSnBTS2ZqWEhGZFJISVlwT3lCRS1peEhCb1h2cVFJTjY2REk1amlJUFlEQUFBfjCw36joBTgNQJVO'
        self.headers = {
